"""Питонические Воины: Тёмная Сторона Кода."""
...
def defence(char_name: str, char_class: str) -> str:
    ...
    в зависимости от выбранного типа персонажа и возвращает
    строковое сообщение о выполненном блокировании атаки."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    В качестве параметров она получает введённое игроком имя
    персонажа и выбранный тип персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Позволяет игроку выбрать тип игрового
    персонажа и возвращает выбранный вариант."""
    approve_choice: str = ''
    char_class: str = ''
